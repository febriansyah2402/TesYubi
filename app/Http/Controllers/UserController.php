...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        return redirect()->route('users.index')->withSuccess(__('Data Berhasil Disimpan',['name' => __('users.store')]));
    }
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        if(auth()->check()){
            return redirect()->route('users.index')->withSuccess(__('Data Berhasil Diupdate',['name' => __('message.user')]));
        }
        return redirect()->back()->withSuccess(__('Data Berhasil Diupdate',['name' => 'My Profile']));
